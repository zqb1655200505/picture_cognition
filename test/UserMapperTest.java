...
public class UserMapperTest {
    ...
    public void selectByUsernameAndPassword() throws Exception {
        ...
        User user = userMapper.selectByUsernameAndPassword("geek_huangfugui@163.com","qwe123qwe",UserType.ADMINISTRATOR);
        System.out.println(user);
    }

    @Test
    public void updateSexById() throws Exception {
        int result = userMapper.updateSexById(10, Sex.FEMALE);
        System.out.println(result);
    }
}